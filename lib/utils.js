...
var _unreleasedLabels = _interopRequireDefault(require("@babel/preset-env/data/unreleased-labels"));

var _targetsParser = require("@babel/preset-env/lib/targets-parser");
...
const isPolyfillSource = source => source === "@babel/polyfill" || source === "uni-app-core-js";
...
const getModulePath = mod => modulePathMap[mod] || `uni-app-core-js/modules/${mod}`;
