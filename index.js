...
var pathBase = "@babel/preset-env/";

var _builtIns = _interopRequireDefault(require(pathBase+"data/built-ins.json"));

var _debug = require(pathBase+"lib/debug");

var _defaults = require(pathBase+"lib/defaults");

var _moduleTransformations = _interopRequireDefault(require(pathBase+"lib/module-transformations"));

var _normalizeOptions = _interopRequireDefault(require(pathBase+"lib/normalize-options.js"));

var _plugins = _interopRequireDefault(require(pathBase+"/data/plugins.json"));

var _shippedProposals = require(pathBase+"/data/shipped-proposals.js");

var _useBuiltInsEntryPlugin = _interopRequireDefault(require(pathBase+"lib/use-built-ins-entry-plugin"));

var _useBuiltInsPlugin = _interopRequireDefault(require("./lib/use-built-ins-plugin"));

var _targetsParser = _interopRequireDefault(require(pathBase+"lib/targets-parser"));

var _availablePlugins = _interopRequireDefault(require(pathBase+"lib/available-plugins"));

var _utils = require(pathBase+"lib/utils");
